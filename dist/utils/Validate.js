...
exports.validateAuthorizeGrata = exports.validateGrata = exports.validateNumber = exports.validateString = exports.validateInsertBonoFinal = void 0;
const validateInsertBonoFinal = (codigo_Empleado, bono_Final, anio) => {
    const errors = [];
    if (!codigo_Empleado) {
...
exports.validateInsertBonoFinal = validateInsertBonoFinal;
const validateString = (varString) => {
...
const validateNumber = (varNumber) => {
...
const validateGrata = (presupuestoFinanzas, presupuestoMinas, presupuestoPelet, presupuestoRH, presupuestoGeneral, presupuestoBeneficio, presupuestoTec, presupuestoDirectores, anio, fechaFin, fechaInicio, dataExcel) => {
    const errors = [];
    if (!anio) {
        errors.push("El año es requerido");
    }
    ...
    if (!presupuestoFinanzas) {
        ...
        errors.push("El presupuesto de la dirección de finanzas tiene que ser numerico");
    }
    if (!presupuestoMinas) {
        errors.push("El presupuesto de la dirección de minas es requerido");
    }
    else if (isNaN(presupuestoMinas)) {
        errors.push("El presupuesto de la dirección de minas tiene que ser numerico");
    }
    if (!presupuestoPelet) {
        errors.push("El presupuesto de la dirección de peletizado es requerido");
    }
    else if (isNaN(presupuestoPelet)) {
        errors.push("El presupuesto de la dirección de peletizado tiene que ser numerico");
    }
    if (!presupuestoRH) {
    ...
    if (!presupuestoGeneral) {
        ...
        errors.push("El presupuesto de la dirección general tiene que ser numerico");
    }
    if (!presupuestoBeneficio) {
        ...
        errors.push("El presupuesto de la dirección de beneficio tiene que ser numerico");
    }
    if (!presupuestoTec) {
        errors.push("El presupuesto de la dirección tecnologíca es requerido");
    }
    else if (isNaN(presupuestoTec)) {
        errors.push("El presupuesto de la dirección tecnologíca tiene que ser numerico");
    }
    if (!presupuestoDirectores) {
        ...
        errors.push("El presupuesto de la dirección de directores tiene que ser numerico");
    }
    if (!fechaFin) {
...
exports.validateGrata = validateGrata;
const validateAuthorizeGrata = (anio, idDireccion, tipoAutorizacion, direccionAutorizacion) => {
    const errors = [];
    if (!anio) {
        errors.push("El año es requerido");
    }
...
exports.validateAuthorizeGrata = validateAuthorizeGrata;
